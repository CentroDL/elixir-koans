defmodule Functions do
  ...
  koan "You can pass functions around as arguments. Place an '&' before the name and state the arity" do #arity?
  ...
  koan "The result of a function can be piped into another function as its first argument" do
    result =
      "full-name"
      |> String.split("-")
      |> Enum.map(&String.capitalize/1) #arity again here, what is that?
      |> Enum.join(" ")
